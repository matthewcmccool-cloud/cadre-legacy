...
export const MOCK_ROLES: Record<string, Job[]> = {
  c1: [
    { id: "j1", title: "Senior Backend Engineer", location: "NYC", function_bucket: "eng", seniority_level: "senior", first_seen_at: "2026-02-13T00:00:00Z", is_new: true },
    { id: "j2", title: "Staff Platform Engineer", location: "NYC", function_bucket: "eng", seniority_level: "staff", first_seen_at: "2026-02-12T00:00:00Z", is_new: true },
    { id: "j3", title: "ML Engineer, Risk", location: "NYC", function_bucket: "eng", seniority_level: "senior", first_seen_at: "2026-02-10T00:00:00Z", is_new: true },
    { id: "j4", title: "Senior Frontend Engineer", location: "NYC", function_bucket: "eng", seniority_level: "senior", first_seen_at: "2026-02-03T00:00:00Z", is_new: false },
    { id: "j5", title: "Engineering Manager, Payments", location: "NYC", function_bucket: "eng", seniority_level: "manager", first_seen_at: "2026-02-01T00:00:00Z", is_new: false },
    { id: "j6", title: "Enterprise Account Executive", location: "NYC", function_bucket: "gtm", seniority_level: "senior", first_seen_at: "2026-02-14T00:00:00Z", is_new: true },
    { id: "j7", title: "Sr Product Marketing Manager", location: "NYC", function_bucket: "gtm", seniority_level: "senior", first_seen_at: "2026-02-13T00:00:00Z", is_new: true },
    { id: "j8", title: "Account Executive, Mid-Market", location: "SF", function_bucket: "gtm", seniority_level: "mid", first_seen_at: "2026-02-06T00:00:00Z", is_new: false },
    { id: "j9", title: "SDR, Enterprise", location: "NYC", function_bucket: "gtm", seniority_level: "entry", first_seen_at: "2026-02-04T00:00:00Z", is_new: false },
    { id: "j10", title: "Head of People Operations", location: "NYC", function_bucket: "ops", seniority_level: "director", first_seen_at: "2026-02-11T00:00:00Z", is_new: true },
    { id: "j11", title: "Senior Financial Analyst", location: "NYC", function_bucket: "ops", seniority_level: "senior", first_seen_at: "2026-02-04T00:00:00Z", is_new: false },
    { id: "j12", title: "VP of Engineering", location: "NYC", function_bucket: "exec", seniority_level: "vp", first_seen_at: "2026-02-10T00:00:00Z", is_new: true },
    { id: "j13", title: "VP of Sales, Enterprise", location: "NYC", function_bucket: "exec", seniority_level: "vp", first_seen_at: "2026-01-28T00:00:00Z", is_new: false },
    { id: "j14", title: "Chief of Staff", location: "NYC", function_bucket: "exec", seniority_level: "director", first_seen_at: "2026-01-24T00:00:00Z", is_new: false },
  ],
  c7: [],
  c3: [
    { id: "j20", title: "Senior Full-Stack Engineer", location: "SF", function_bucket: "eng", seniority_level: "senior", first_seen_at: "2026-02-12T00:00:00Z", is_new: true },
    { id: "j21", title: "Backend Engineer, Data Pipeline", location: "SF", function_bucket: "eng", seniority_level: "mid", first_seen_at: "2026-02-12T00:00:00Z", is_new: true },
    { id: "j22", title: "Staff Engineer, Carbon Accounting", location: "SF", function_bucket: "eng", seniority_level: "staff", first_seen_at: "2026-02-11T00:00:00Z", is_new: true },
    { id: "j23", title: "Enterprise Account Executive", location: "SF", function_bucket: "gtm", seniority_level: "senior", first_seen_at: "2026-02-11T00:00:00Z", is_new: true },
    { id: "j24", title: "Customer Success Manager", location: "SF", function_bucket: "gtm", seniority_level: "mid", first_seen_at: "2026-02-11T00:00:00Z", is_new: true },
    { id: "j25", title: "Head of Finance", location: "SF", function_bucket: "ops", seniority_level: "director", first_seen_at: "2026-02-12T00:00:00Z", is_new: true },
  ],
};
