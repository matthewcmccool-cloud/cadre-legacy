...
import { getIndustryBySlug, getJobsForIndustry } from '@/lib/airtable';
...
export default async function IndustryPage({ params }: IndustryPageProps) {
  ...
  // Get ALL jobs in this industry (not just 100)
  const jobs = await getJobsForIndustry(industry.id);
